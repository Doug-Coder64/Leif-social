...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/dougpeterson/projects/Leif-social/lib",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "relativeEnvPaths": {
    "rootEnvPath": "../.env",
    "schemaEnvPath": "../../Leif-api/.env"
  },
  "relativePath": "../../Leif-api/prisma",
  "clientVersion": "4.4.0",
...
path.join(process.cwd(), "../Leif-social/lib/libquery_engine-darwin-arm64.dylib.node")
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "../Leif-social/lib/schema.prisma")
